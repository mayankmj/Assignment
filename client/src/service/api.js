...
const forgotPassword = async (email) => {
    try {
        // Make a POST request to the forgot password endpoint with the email parameter
        const response = await axiosInstance.post('/forgot-password', { email }, {
            headers: {
                Authorization: getAccessToken() // Include the access token in the request headers
            }
        });
...
const API = {
    forgotPassword, // Add the forgotPassword function to the API object
};
